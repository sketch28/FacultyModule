...
public class AttendenceAdapter extends RecyclerView.Adapter<AttendenceAdapter.MyViewHolder> {
    ...
    public AttendenceAdapter(Context context, ArrayList<Students> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.sName.setText(students.getStudentName());
        holder.sRollno.setText(students.getRollNo());
        holder.sDepartment.setText(students.getDepartment());
        holder.sBatch.setText(students.getBatches());
        holder.sYear.setText(students.getYears());
