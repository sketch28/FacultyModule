...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtstaffName= (TextView) findViewById(R.id.txtUserEmail);
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Staff staffUName = snapshot.getValue(Staff.class);
                String staffName = staffUName.getStaffname();

                if(staffUName != null){


                    txtstaffName.setText("Welcome "+ staffName + "!");

                }
                if(staffUName.getProfilepicture() !=null){
                    Glide.with(Profile.this)
                            .load(staffUName.getProfilepicture())
                            .into(imgProfile);
                }
            }
    ...
    private void updateProfilePicture(String url){
        FirebaseDatabase.getInstance().getReference("staff/" +FirebaseAuth.getInstance().getCurrentUser().getUid()+ "/profilepicture").setValue(url);
    }
