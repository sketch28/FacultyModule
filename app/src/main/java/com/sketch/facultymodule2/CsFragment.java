...
public class CsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CSView= inflater.inflate(R.layout.fragment_cs, container, false);
        btnAddStudents = (Button) CSView.findViewById(R.id.add_students_rb_cs);
        btnClear = (Button) CSView.findViewById(R.id.btn_clear_rb_cs);
        radioGroupDepartment = (RadioGroup) CSView.findViewById(R.id.gr_Department_cs);
        radioGroupYears = (RadioGroup) CSView.findViewById(R.id.gr_Years_cs);
        radioGroupBatches = (RadioGroup) CSView.findViewById(R.id.gr_batches_cs);
        //Department
        rbCs = (RadioButton) CSView.findViewById(R.id.rb_CS);
//        rbIt = (RadioButton) getView().findViewById(R.id.rb_IT);
        //Years
        rb1yr = (RadioButton) CSView. findViewById(R.id.rb_first_year_cs);
        rb2yr = (RadioButton) CSView.findViewById(R.id.rb_second_year_cs);
        rb3yr = (RadioButton) CSView. findViewById(R.id.rb_third_year_cs);
        rb4yr = (RadioButton) CSView.findViewById(R.id.rb_fourth_year_cs);
        //Batches
        rb1batch = (RadioButton) CSView.findViewById(R.id.rb_first_batch_cs);
        rb2batch = (RadioButton) CSView.findViewById(R.id.rb_second_batch_cs);

        ilName = (TextInputLayout) CSView.findViewById(R.id.tLayoutName_cs);
        ilRollno = (TextInputLayout) CSView.findViewById(R.id.tLayoutRollNo_cs);
        iledtName = (TextInputEditText) CSView.findViewById(R.id.TIedtName_cs);
        iledtRollno = (TextInputEditText) CSView.findViewById(R.id.TIedtRollNo_cs);
